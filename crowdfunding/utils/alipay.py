...
if __name__ == "__main__":
    ...
    #实例化支付类
    alipay = AliPay(
        appid="2016091700535827",
        #支付宝服务器主动通知商户服务器里指定的页面http/https路径
        app_notify_url="http://127.0.0.1:8000/alipay/return/",
        app_private_key_path="../apps/trades/keys/app_private_2048.txt",
        alipay_public_key_path="../apps/trades/keys/alipay_public.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,
        #同步通知，回调这个地址
